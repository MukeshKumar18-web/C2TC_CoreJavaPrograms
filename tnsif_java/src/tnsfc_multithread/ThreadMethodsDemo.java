...
public class ThreadMethodsDemo {
		...
		public static void main(String[] args) {
			ChildThread threadOne = new ChildThread(8, "First"); // creating child thread object
			ChildThread threadTwo = new ChildThread(16, "Second"); // creating child thread object
